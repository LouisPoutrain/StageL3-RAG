...
from rag.components import HypotheticalDocumentEmbedder
...
def create_hyde_pipeline(api_key: str, api_url: str, embedder_model: str, invasive_detection: bool = False) -> Pipeline:
    ...
    if invasive_detection:
         hyde_pipeline.add_component(
            ...
            Rédige la réponse en anglais, même si la question ou le titre est dans une autre langue.
        ...
        hyde_pipeline.add_component(
            ...
            Rédige l'extrait en anglais, même si les informations fournies sont dans une autre langue.
